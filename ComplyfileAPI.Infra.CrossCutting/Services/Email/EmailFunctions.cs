...
namespace ComplyfileAPI.Infra.CrossCutting.Services.Email
{
    public class EmailFunctions : IEmailFunctions
    {
        ...
        public bool SendEmail(EmailModel emailModel)
        {
            try
            {
                // we need to set LastUpdatedBy_ID for Currently Logged on Volunteer OR Complyfile Admin   
        ...
        public async Task<bool> SendVolunteerInviteEmail(Volunteer vol, string token, int orgID, string currentUserEmail, List<KeyValuePair<string, Stream>> Attachments = null)
        {
            ...
            mail.From = new MailAddress("donotreply@complyfile.com");
            ...
            if (template != null)
            {
                ...
                var linktocomplyfilesales = "<a href=\"http://www.complyfile.com\">Complyfile</a>";
                var privacyLink = "<a href=\"https://complyfile.com/privacy-statement-cookies-policy\">Privacy</a>";
                var legalLink = "<a href=\"https://complyfile.com/EULA\">Legal</a>";
                ...
                tempBody = tempBody.Replace("[LinkToComplyfileSales]", linktocomplyfilesales);
